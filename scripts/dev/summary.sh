...
POSTGRES_DB_NAME="${POSTGRES_DB:-roadfx}"
POSTGRES_USERNAME="${POSTGRES_USER:-roadfx}"
POSTGRES_SECRET="${POSTGRES_PASSWORD:-roadfx}"
REDIS_HOST_PORT="${REDIS_PORT:-6379}"
API_PORT="${ROADFXAPI_PORT:-8000}"
AI_PORT="${ROADFXAI_PORT:-8081}"
RAG_PORT="${ROADFXRAG_PORT:-18082}"
PLATFORM_PORT="${ROADFXPLATFORM_PORT:-8003}"
WORKFLOW_PORT="${ROADFXWORKFLOW_PORT:-8004}"
PLUGIN_RUNTIME_PORT="${ROADFXPLUGIN_RUNTIME_PORT:-8090}"
DEVICE_CONTROL_PORT="${ROADFXDEVICE_CONTROL_PORT:-8085}"
WEB_PORT="${ROADFXWEB_PORT:-5173}"
WIDGET_PORT="${ROADFXWIDGET_PORT:-5174}"
