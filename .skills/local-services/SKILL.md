...
2. **roadfx-api** — Core API gateway (port 8000)
3. **roadfx-ai** — LLM / Agent runtime (port 8081)
...
| roadfx-api | `make dev-api` | 8000 | Always |
| roadfx-ai | `make dev-ai` | 8081 | Always |
| roadfx-rag | `make dev-rag` | 18082 | Knowledge base / RAG changes |
| roadfx-platform | `make dev-platform` | 8003 | Channel integration changes |
| roadfx-workflow | `make dev-workflow` | 8004 | Workflow engine changes |
| roadfx-plugin-runtime | `make dev-plugin` | 8090 | Plugin / MCP tool changes |
| roadfx-device-control | `make dev-device` | 8085 | Device management changes |
| roadfx-web | `make dev-web` | 5173 | Admin frontend changes |
| roadfx-widget-js | `make dev-widget` | 5174 | Visitor widget changes |
