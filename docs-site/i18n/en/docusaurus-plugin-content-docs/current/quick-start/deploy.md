...
This page explains how to quickly install ROADFX using the one-click deployment script.
...
ROADFX uses the following default ports:
...
After installation, you can access ROADFX via:
