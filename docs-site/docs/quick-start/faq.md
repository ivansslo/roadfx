...
```bash
# 修改 HTTP 端口为 8080
./roadfx.sh config http_port 8080

# 修改 HTTPS 端口为 8443
./roadfx.sh config https_port 8443
```
...
1. 查看完整日志：
   ```bash
   docker compose logs > roadfx-logs.txt
   ```

2. 在 [GitHub Issues](https://github.com/ivansslo/roadfx/issues) 提交问题，附上：
   - 操作系统版本
   - Docker 版本
   - 错误日志
   - 复现步骤
