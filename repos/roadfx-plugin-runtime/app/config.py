...
class Settings(BaseSettings):
    ...
    # Service Info
    SERVICE_NAME: str = Field(default="ROADFX Plugin Runtime")
    ...
    PLUGIN_SOCKET_PATH: str = Field(
        default="/var/run/roadfx/roadfx.sock",
    ...
    AI_SERVICE_URL: str = Field(
        ...
        description="URL of the ROADFX AI service for tool sync",
    )
    ...
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/roadfx",
    ...
    SECRET_KEY: str = Field(
        ...
        description="Secret key for JWT verification (must match roadfx-api)",
    )

    # Plugin Storage
    PLUGIN_BASE_PATH: str = Field(
        default="/var/lib/roadfx/plugins",
