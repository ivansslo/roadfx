...
class ProcessManager:
    ...
    def __init__(self, base_path: str = "/var/lib/roadfx/plugins"):
    ...
    async def _start_plugin_inner(self, plugin_id: str, config: Dict[str, Any]) -> Tuple[bool, str]:
        ...
        env["ROADFXSOCKET_PATH"] = settings.PLUGIN_SOCKET_PATH
        if settings.PLUGIN_TCP_PORT:
            env["ROADFXTCP_PORT"] = str(settings.PLUGIN_TCP_PORT)
