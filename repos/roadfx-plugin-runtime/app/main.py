"""FastAPI application entry point for ROADFX Plugin Runtime."""
...
async def lifespan(application: FastAPI):
    ...
    startup_log("=" * 64)
    startup_log("🔌 ROADFX Plugin Runtime Service Starting...")
    startup_log("=" * 64)
...
app = FastAPI(
    ...
    description="Plugin Runtime Service for ROADFX - manages plugin connections and provides HTTP APIs",
