"""
Main FastAPI application for ROADFX RAG Service.
"""
...
async def lifespan(app: FastAPI):
    ...
    log_startup_step("Starting ROADFX RAG Service initialization", version=settings.app_version, environment=settings.environment)
    ...
    try:
        ...
        log_startup_step("Shutting down ROADFX RAG Service")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="ROADFXTech RAG (Retrieval-Augmented Generation) Service for document processing and semantic search",
        docs_url="/docs",
        redoc_url="/redoc",
