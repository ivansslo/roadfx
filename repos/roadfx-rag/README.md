...
The ROADFX RAG Service is a microservice designed to handle the complete document lifecycle for RAG operations - from file upload and processing to semantic search and context retrieval. It features a modern, scalable architecture with multi-tenant support, async processing, and enterprise-grade reliability.
...
│   ├── ROADFXRAG_Service_Documentation.yaml # OpenAPI spec
...
- **[OpenAPI Specification](docs/ROADFXRAG_Service_Documentation.yaml)** - Complete API reference
...
This project is proprietary software owned by ROADFXTech. All rights reserved.
...
- **📧 Email**: rag-support@roadfx-tech.com
- **💬 Discussions**: Use GitHub Discussions for questions and ideas

---

**Built with ❤️ by the ROADFXTech Team**
