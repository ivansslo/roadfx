...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="sqlite+aiosqlite:///./roadfx_ai_service.db",
    ...
    device_control_mcp_endpoint: str = Field(
        default="http://roadfx-device-control:8085/mcp/{device_id}",
    ...
    test_database_url: str = Field(
        default="postgresql+asyncpg://postgres:password@localhost:5432/roadfx_ai_service_test",
