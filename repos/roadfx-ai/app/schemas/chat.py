...
class ChatCompletionRequest(BaseModel):
    ...
    # ROADFXAI specific: provider credentials lookup
    ...
    # ROADFXAI Extension: Dynamic Tool Loading
    ...
    auto_execute_tools: bool = Field(
        default=True,
        description="Whether roadfx-ai should auto-execute tool calls in an agentic loop. "
        "When True (default), roadfx-ai executes tool calls internally and continues the conversation. "
