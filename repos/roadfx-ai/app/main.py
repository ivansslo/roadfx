...
from app.exceptions import ROADFXAIServiceException
...
app = FastAPI(
    title="ROADFXTech AI Service",
    description="AI/ML Operations Microservice for ROADFXTech customer service platform",
    version=__version__,
...
@app.exception_handler(ROADFXAIServiceException)
async def roadfx_ai_service_exception_handler(
    request: Request, exc: ROADFXAIServiceException
) -> JSONResponse:
    """Handle custom ROADFX AI Service exceptions."""
