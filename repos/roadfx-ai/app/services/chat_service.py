...
class ProviderNotFoundError(ROADFXAIServiceException):
...
class ProviderNotActiveError(ROADFXAIServiceException):
...
class UnsupportedProviderError(ROADFXAIServiceException):
...
class ChatCompletionError(ROADFXAIServiceException):
