"""API Service client for interacting with the core ROADFX API service."""
...
class APIServiceClient:
    """Client for interacting with the core ROADFX API service."""
    ...
    async def execute_plugin_tool(
        ...
        """
        Execute a plugin tool via the ROADFX Plugin Runtime service.
