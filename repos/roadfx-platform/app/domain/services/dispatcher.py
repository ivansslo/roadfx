...
async def process_message(
    ...
    """End-to-end orchestration using DB platform config + roadfx-api SSE + adapter output.
    ...
    for attempt in range(3):
        try:
            ...
            # Choose platform-specific expected output format for roadfx-api
            ...
            frames = roadfx_api_client.chat_completion(req)
