...
async def lifespan(app: FastAPI):
    ...
    app.state.roadfx_api_client = HttpxTgoApiClient(settings.api_base_url, timeout=settings.request_timeout_seconds)
    ...
    app.state.email_listener = EmailChannelListener(
        ...
        roadfx_api_client=app.state.roadfx_api_client,
    ...
    try:
        ...
        await app.state.roadfx_api_client.aclose()
