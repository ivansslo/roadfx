# ROADFX Widget App (Vite + React + Emotion)
...
- Emotion 样式注入：可在 DevTools 中看到 `<style data-emotion="roadfx">` 与 `<style data-emotion="roadfx-global">`
...
./roadfx-widget-js
  ...
  └─ src/
     ...
     ├─ App.tsx
     ├─ styles/
     │  └─ emotionCache.ts   # key = "roadfx" → <style data-emotion="roadfx">
     └─ components/
        ├─ Header.tsx
        ├─ MessageList.tsx
        └─ MessageInput.tsx
