...
const WELCOME_KEY = (apiBase: string, platformApiKey: string) => `roadfx:welcome-shown:${apiBase}:${platformApiKey}`
const EXPANDED_KEY = (apiBase: string, platformApiKey: string) => `roadfx:expanded:${apiBase}:${platformApiKey}`
