# roadfx-widget-miniprogram — AGENTS.md

> Stack: Pure JS (ES5), WeChat mini-program native components
> Sister project: `roadfx-widget-js` (React Web) — json-render logic must stay in sync
...
- json-render changes must stay consistent with `roadfx-widget-js`
...
# Functional — same visitor APIs as roadfx-widget-js
