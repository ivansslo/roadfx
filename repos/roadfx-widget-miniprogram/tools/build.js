 ...
 *
 * Also syncs to example/node_modules/roadfx-widget-miniprogram for local dev.
 */
const fs = require('fs')
...
async function main() {
  ...
  // 3. Sync to example/node_modules/roadfx-widget-miniprogram
  const EXAMPLE_NODE_MOD = path.resolve(__dirname, '..', 'example', 'node_modules', 'roadfx-widget-miniprogram')
