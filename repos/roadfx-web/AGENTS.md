...
# Functional — roadfx-web calls roadfx-api; use CLI to verify the APIs it depends on
ROADFX_CLI="node ../roadfx-cli/dist/index.js"
$ROADFX_CLI auth whoami                    # auth flow
$ROADFX_CLI conversation list --limit 1    # conversation API
$ROADFX_CLI agent list --limit 1           # agent API
```
