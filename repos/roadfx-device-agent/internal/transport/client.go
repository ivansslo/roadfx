...
// roadfx-device-control, handles authentication, heartbeat, reconnection,
...
import (
	...
	"github.com/ivansslo/roadfx-device-agent/internal/protocol"
	"github.com/ivansslo/roadfx-device-agent/internal/tools"
)

// Client manages the TCP connection to roadfx-device-control.
type Client struct {
	cfg      *config.Config
