...
ROADFX 是一个 AI 驱动的全渠道客服平台，采用微服务架构，包含 8 个 Python 后端服务、1 个 Go Agent、2 个 React 前端、1 个微信小程序组件和 2 个 Node.js CLI 工具。

## 项目列表

| 项目 | 简介 | 技术栈 | 端口 |
|------|------|--------|------|
| [roadfx-api](#roadfx-api) | 核心业务 API | Python / FastAPI | 8000, 8001 |
| [roadfx-ai](#roadfx-ai) | AI 服务 (Agent / 知识库 / 用量) | Python / FastAPI | 8081 |
| [roadfx-platform](#roadfx-platform) | 多渠道消息集成 | Python / FastAPI | 8003 |
| [roadfx-rag](#roadfx-rag) | RAG 检索增强生成 | Python / FastAPI | 8082 |
| [roadfx-workflow](#roadfx-workflow) | 工作流引擎 | Python / FastAPI / Celery | 8000 |
| [roadfx-plugin-runtime](#roadfx-plugin-runtime) | 插件运行时 | Python / FastAPI | 8090 |
| [roadfx-device-control](#roadfx-device-control) | 设备远程控制服务 | Python / FastAPI | 8085, 9876 |
| [roadfx-device-agent](#roadfx-device-agent) | 设备端 Agent | Go | TCP 客户端 |
| [roadfx-web](#roadfx-web) | 客服工作台前端 | React 19 / TypeScript / Vite | 5173 |
| [roadfx-widget-js](#roadfx-widget-js) | 网页嵌入式聊天组件 | React 18 / TypeScript / Vite | 5173 |
| [roadfx-widget-miniprogram](#roadfx-widget-miniprogram) | 微信小程序聊天组件 | 微信小程序 / JS | npm 包 |
| [roadfx-cli](#roadfx-cli) | 命令行工具 + MCP Server (客服端) | Node.js / TypeScript | CLI / stdio |
| [roadfx-widget-cli](#roadfx-widget-cli) | 命令行工具 + MCP Server (访客端) | Node.js / TypeScript | CLI / stdio |
...
- **端口**: 8090
- **职责**: 插件生命周期管理、Unix Socket/TCP 通信、进程管理、工具同步至 roadfx-ai
...
- **技术栈**: Go 1.22
- **协议**: TCP JSON-RPC 2.0，连接至 roadfx-device-control 的 9876 端口
...
- **分发**: npm 包 (`roadfx-widget-miniprogram`)
...
- **命令参考**: 详见 [`roadfx-cli/COMMANDS.md`](./roadfx-cli/COMMANDS.md)
...
- **命令参考**: 详见 [`roadfx-widget-cli/COMMANDS.md`](./roadfx-widget-cli/COMMANDS.md)
...
| Kafka | 事件流 (roadfx-api ↔ 各服务间异步通信) |
| WuKongIM | 即时通讯引擎，WebSocket 消息收发 |
| Celery | 异步任务 (roadfx-rag 文档处理、roadfx-workflow 工作流执行) |
