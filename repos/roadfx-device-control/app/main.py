"""FastAPI application entry point for ROADFX Device Control Service."""
...
async def lifespan(application: FastAPI):
    ...
    startup_log("=" * 64)
    startup_log("  ROADFX Device Control Service Starting...")
    startup_log("=" * 64)
...
app = FastAPI(
    ...
    description="Device Control Service for ROADFX - MCP transparent proxy for remote devices",
