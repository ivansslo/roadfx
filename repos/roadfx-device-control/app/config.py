...
class Settings(BaseSettings):
    ...
    # Service Info
    SERVICE_NAME: str = Field(default="ROADFX Device Control")
    ...
    API_SERVICE_URL: str = Field(
        ...
        description="URL of the ROADFX API service",
    )

    # Database Configuration
    DATABASE_URL: str = Field(
        default="postgresql+asyncpg://roadfx:tgo@localhost:5432/roadfx",
    ...
    STORAGE_LOCAL_PATH: str = Field(
        default="/var/lib/roadfx/device-control/screenshots",
