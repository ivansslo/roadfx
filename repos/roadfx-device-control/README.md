...
ROADFX Device Control 是一个设备控制服务，允许 AI Agent 远程控制用户的电脑或移动设备。
...
```bash
# 构建镜像
make build SERVICE=roadfx-device-control

# 或者手动构建
docker build -t roadfx-device-control .
```
