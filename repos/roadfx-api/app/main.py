...
def create_app(
    ...
    application.add_exception_handler(ROADFXAPIException, roadfx_api_exception_handler)
    ...
    async def startup_event():
        ...
        startup_log("")
        startup_log("🎉 ROADFXTech API Service is ready!")
        startup_log("═" * 64)
    ...
    async def root() -> dict[str, str]:
        """Root endpoint."""
        return {"message": "ROADFXTech API Service", "version": settings.PROJECT_VERSION}
