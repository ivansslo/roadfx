...
internal_app.add_exception_handler(ROADFXAPIException, roadfx_api_exception_handler)
...
async def internal_root() -> dict[str, str]:
    ...
    return {
        "message": "ROADFXTech Internal Services",
        "version": settings.PROJECT_VERSION,
...
async def internal_startup_event():
    ...
    startup_log("═" * 64)
    startup_log("🔧 ROADFXTech Internal Services Starting...")
    startup_log("═" * 64)
