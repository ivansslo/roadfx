"""Plugin Tools proxy endpoints - Proxies to roadfx-plugin-runtime service."""
...
async def execute_plugin_tool(
    ...
    """
    Proxy an MCP tool execution request to roadfx-plugin-runtime.
    
    Called by roadfx-ai when an agent uses a plugin-provided tool.
    """
