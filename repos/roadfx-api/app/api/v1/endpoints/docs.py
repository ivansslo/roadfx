...
- /docs/api - Current API service (roadfx-api)
- /docs/ai - AI service
...
@router.get("/api", response_class=HTMLResponse, summary="ROADFX API Documentation")
async def docs_api():
    """Swagger UI for the current ROADFX API service."""
    return HTMLResponse(_swagger_ui_html("ROADFX API Service", f"{settings.API_V1_STR}/openapi.json"))
