...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = Field(
        default="ROADFXTech API Service",
    ...
    API_BASE_URL: str = Field(
        ...
        description="Public-facing base URL for this ROADFX API service (used to construct callback URLs)"
    )
    ...
    # Platform Service settings (ROADFX Platform Service)
    PLATFORM_SERVICE_URL: str = Field(
        default="http://localhost:8003",
        description="URL of the ROADFX Platform Service",
    )
    ...
    PLUGIN_RUNTIME_URL: str = Field(
        ...
        description="URL of the roadfx-plugin-runtime service",
    )
    ...
    DEVICE_CONTROL_SERVICE_URL: str = Field(
        ...
        description="URL of the roadfx-device-control service",
    )
