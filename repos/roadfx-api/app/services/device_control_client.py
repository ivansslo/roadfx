"""Device Control Service Client - HTTP client for roadfx-device-control service."""
...
class DeviceControlClient:
    """HTTP client for communicating with roadfx-device-control service."""
    ...
    async def run_agent_stream(
        ...
        Args:
            ...
            provider_id: AI Provider ID for LLM calls via roadfx-ai service.
